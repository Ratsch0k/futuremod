...
pub fn icon_with_size<'a, Message>(
    content: Bootstrap,
    size: impl Into<Pixels>,
) -> Container<'a, Message, theme::Theme> {
    align_icon(icon_text(content).size(size))
}

pub fn align_icon<'a, Message>(
    content: impl Into<Element<'a, Message, theme::Theme>>,
) -> Container<'a, Message, theme::Theme> {
...
#[allow(unused)]
pub fn icon_with_color<'a, Message>(
    content: Bootstrap,
    color: Color,
) -> Container<'a, Message, theme::Theme> {
...
#[allow(unused)]
pub fn icon_with_style<'a, Message>(
    content: Bootstrap,
    style: theme::text::Text<'a>,
) -> Container<'a, Message, theme::Theme> {
    align_icon(icon_text(content).class(style))
}

#[allow(unused)]
pub fn icon_with_text<'a, Message: 'a>(
    icon_content: Bootstrap,
    content: impl Into<Element<'a, Message, theme::Theme>>,
) -> Row<'a, Message, theme::Theme> {
    row![icon(icon_content), content.into(),]
