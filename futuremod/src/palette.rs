use iced::{
    color,
    theme::palette::{Pair, Primary, Secondary},
    Color,
};
...
impl Default for Palette {
    fn default() -> Self {
        Palette {
            ...
            success: ColorRange {
                lightest: Pair {
                    color: color!(0xCDFFBA),
                    text: color!(0x000000),
                },
                light: Pair {
                    color: color!(0xB7FF9D),
                    text: color!(0x000000),
                },
                medium: Pair {
                    color: color!(0x9AFF75),
                    text: color!(0xffffff),
                },
                dark: Pair {
                    color: color!(0x155000),
                    text: color!(0xffffff),
                },
                darkest: Pair {
                    color: color!(0x0E3500),
                    text: color!(0xffffff),
                },
            },
            danger: ColorRange {
                lightest: Pair {
                    color: color!(0xF3D1D1),
                    text: color!(0x000000),
                },
                light: Pair {
                    color: color!(0xD35656),
                    text: color!(0x000000),
                },
                medium: Pair {
                    color: color!(0xBF3131),
                    text: color!(0xffffff),
                },
                dark: Pair {
                    color: color!(0x7B2020),
                    text: color!(0xffffff),
                },
                darkest: Pair {
                    color: color!(0x360E0E),
                    text: color!(0xffffff),
                },
            },
            warning: ColorRange {
