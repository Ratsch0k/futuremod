...
fn appearance(theme: &Theme, style: &Text) -> text::Style {
    match style {
        ...
        Text::Warn => text::Style {
            color: Some(theme.palette.warning.medium.color),
        },
        Text::Danger => text::Style {
            color: Some(theme.palette.danger.medium.color),
        },
        Text::Custom(class) => class(theme),
        Text::Base(base) => text::Style {
            color: Some(theme.palette.background.get_base(base).text),
        },
        Text::Shade(shade) => text::Style {
            color: Some(theme.palette.base.get_shade(shade)),
        },
    }
}
